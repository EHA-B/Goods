...
export default function StockAdjustmentPage() {
  ...
  return <form onSubmit={submit} className="space-y-6">
    <PageHeader title="تسوية المخزون" description="تسجيل فرق جرد أو تلف أو تصحيح رصيد مع الاحتفاظ بحركة واضحة." actions={<Button variant="ghost" startIcon={<ArrowRight size={17} />} onClick={() => navigate(-1)}>رجوع</Button>} />
