...
const stockliteApi = {
  ...
  workers: {
    ...
    recordPayment: (input) => invokeApi("api:worker:recordPayment", input),
    reversePayment: (paymentId, reason) => invokeApi("api:worker:reversePayment", paymentId, reason),
    getPayments: (workerId) => invokeApi("api:worker:getPayments", workerId)
  }
};
