...
import * as invoiceEditAuditMigration from './migrations/20260826173000_invoice_edit_audit';
...
class MigrationSource {
  async getMigrations() {
    return Promise.resolve([
      ...
      '20260826173000_invoice_edit_audit.ts',
    ]);
  }
  ...
  async getMigration(migration: string) {
    ...
    if (migration === '20260826173000_invoice_edit_audit.ts') {
      return invoiceEditAuditMigration;
    }
