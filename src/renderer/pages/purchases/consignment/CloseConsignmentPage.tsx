...
export default function CloseConsignmentPage() {
  ...
  useEffect(() => { if (!summary || !cashboxId) return; void consignmentService.getClosingPreview(id, input).then((value) => { setPreview(value); setError(""); }).catch((e) => { setPreview(null); setError(e instanceof Error ? e.message : "تعذر حساب معاينة التسوية."); }); }, [summary, id, input, cashboxId]);
