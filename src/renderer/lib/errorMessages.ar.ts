export const ERROR_MESSAGES_AR: Record<string, string> = {
  ...
  PURCHASE_EDIT_SETTLEMENT_LOCK:
    "لا يمكن تعديل فاتورة الأمانة بعد إنشاء تسوية لها. يجب عكس التسوية أو معالجتها أولًا.",

  INVOICE_EDIT_PAYMENT_LOCK:
    "لا يمكن تغيير العميل أو المورد أو العملة أو سعر الصرف لأن الفاتورة تحتوي على دفعات مسجلة. اعكس الدفعات أولًا ثم حاول من جديد.",
